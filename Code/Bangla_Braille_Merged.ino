...
bool isWordStart()
{
    ...
    // A new word starts after a space, a NEW LINE or any punctuation mark
...
)
{
    ...
    bool zwjBefore[MAX_CHARS];

    bool zwjPending = false;
    ...
    )
    {
        ...
        zwjBefore[charCount] = zwjPending;
        ...
        if (isConsonant(c))
        {
            ...
            if (consonantCount >= 2)
            {
                ...
                if (consonantCount == 2)
                {
                    ...
                    if (zwjBefore[i + 1] || zwjBefore[i + 2])
                    {
                        appendPattern(4);
                    }
                }
